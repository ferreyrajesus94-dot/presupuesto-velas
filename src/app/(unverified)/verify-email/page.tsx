...
/**
 * PR3.auth-ui (Task 3.7) — `/verify-email` page.
 *
 * Server component. Renders mode-agnostic "Check your inbox" copy and
 * embeds the resend form. Unsigned visitors are redirected to
 * `/sign-in` (the page layer enforces session — the action layer only
 * guards against anonymous POSTs as a defense-in-depth).
 *
