...
describe("QuoteCreateForm — submit wiring", () => {
  ...
  it("shows the error message in a polite live region when createQuoteDraftAction fails", async () => {
    ...
    expect(liveRegion).toHaveTextContent(/fecha inválida/);
    expect(liveRegion).toHaveAttribute("aria-live", "polite");
    expect(push).not.toHaveBeenCalled();
    expect(mocks.appendQuoteVersionAction).not.toHaveBeenCalled();
  });

  it("shows the error message when appendQuoteVersionAction fails after a successful draft", async () => {
