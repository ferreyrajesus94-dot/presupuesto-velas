...
const rowGridClass =
  ...
  "grid min-w-0 grid-cols-2 gap-2 px-3 py-3 md:min-w-[72rem] md:grid-cols-[minmax(10rem,1.4fr)_minmax(6rem,0.7fr)_minmax(6rem,0.7fr)_minmax(6.5rem,0.75fr)_minmax(7rem,0.8fr)_minmax(8rem,0.9fr)_minmax(10rem,0.9fr)_minmax(6rem,0.65fr)_minmax(7.5rem,0.8fr)] md:items-start";
